...
def main():
    ...
    transformers.utils.send_example_telemetry("run_clm_no_trainer", args)
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if completed_steps % (5000 * 32 / total_batch_size) == 0 and step % args.gradient_accumulation_steps == 0:
                model.eval()
